 ...
 * @param {DcrFactory} dcrFactory
 * @param {TextRenderer} textRenderer
 */
export default function LabelBehavior(
    eventBus, modeling, dcrFactory,
    textRenderer) {
  ...
  this.postExecute([ 'label.create' ], function(event) {
    ...
    if (!is(element.labelTarget || element, 'dcr:BoardElement')) {
      return;
    }
    ...
    if (!di.label) {
      di.label = dcrFactory.create('dcrDi:OdLabel', {
        bounds: dcrFactory.create('dc:Bounds')
      });
    }
