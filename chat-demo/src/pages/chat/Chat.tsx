...
const Chat = () => {
    ...
    const historyProvider = showChatHistoryBrowser ? HistoryProviderOptions.IndexedDB : HistoryProviderOptions.None;
    ...
    const makeApiRequest = async (question: string) => {
        ...
        try {
            ...
            const response = await chatApi(request, shouldStream, controller.signal);
            if (!response.body) {
